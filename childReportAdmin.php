...
<!-- Add more as needed -->
  ...
  $month = $_POST['month']; // e.g., 7
    ...
    ?>
                         <form class="needs-validation" action="childReportAdmin.php" method="POST" novalidate>
  <div class="form-row">
...
//        echo "SELECT * FROM childRegister WHERE 1 $date_con";
      $query = mysqli_query($conn, "SELECT * FROM childRegister WHERE 1  $filter $date_con");
