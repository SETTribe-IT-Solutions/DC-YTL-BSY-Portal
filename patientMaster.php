                  ...
                  <div class="card shadow mb-4">
                   <!-- <div class="card-header eleven">
                    ...
                    <div class="card-body">
                      ...
                      <form class="needs-validation" action="patientDb.php" method="POST" novalidate>
                        <div class="form-row">

                        <?php
$query = mysqli_query($conn,"SELECT * FROM `visitedArea` where teamId='$teamId' AND userId='$userId' AND visitDate='$date'") or die($conn->error);
...
<div class="col-md-6 mb-3">
                            ...
                            <div class="input-group">
                              <input type="text" class="form-control" id="visitDate" name="patientName"  aria-describedby="button-addon2">
                           
                            </div>
                          </div>

                                <div class="col-md-6 mb-3">
                                    <label for="date-input1"><strong>Age<b style="color:red">*</b></strong></label>
                            <div class="input-group">
                              <input type="text" class="form-control" id="Age" name="Age"  aria-describedby="button-addon2">
                         ...
                         <option>Male</option>
                          <option>Female</option>
                           <option>Other</option>
                            ...
                            <div class="input-group">
                              <input type="text" class="form-control" id="Aadhar" name="Aadhar"  aria-describedby="button-addon2">
                            ...
                            <div class="input-group">
                              <input type="text" class="form-control" id="mobileNumber" name="mobileNumber"  aria-describedby="button-addon2">
