...
<head>
    ...
    <title>जिल्हा महिला व बाल विकास अधिकारी डॅशबोर्ड</title>
...
<body>
    ...
    <div class="dashboard-container">
        <div class="dashboard-header text-center">
            <h1 class="dashboard-title">जिल्हा महिला व बाल विकास अधिकारी डॅशबोर्ड</h1>
        ...
        <div class="row justify-content-center">
            ...
            <div class="counter">
                <div class="counter-content">
                    ...
                    <h3>परिवीक्षा अधिकारी ह्यांनी फॉरवर्ड केलेले लाभार्थी</h3>
                </div>
        ...
        <div class="chart-container">
            <div class="row">
                <div class="col-md-12 mb-5">
                    <div class="chart-title">परिवीक्षा अधिकारी ह्यांनी फॉरवर्ड केलेले लाभार्थी</div>
