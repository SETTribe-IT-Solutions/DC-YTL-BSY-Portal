...
<body>
    ...
    <div class="dashboard-container">
        <div class="dashboard-header text-center">
            <h1 class="dashboard-title">जिल्हा बाल संरक्षण कक्ष डॅशबोर्ड</h1>
    ...
    <select class="form-select" id="yearSelect"></select>
        ...
        <div class="col-md-3 col-sm-6">
            <div class="counter green">
                <div class="counter-content">
                    ...
                    <h3>स्क्रूटीनी १ साठी प्रलंबित अर्ज</h3>
                </div>
        ...
        <div class="col-md-3 col-sm-6">
            <div class="counter blue">
                <div class="counter-content">
                    ...
                    <h3>स्क्रूटीनी १ मध्ये रिजेक्टेड अर्ज</h3>
                </div>
        ...
        <div class="col-md-3 col-sm-6">
         ...
         <!-- गृह चौकशी -->
        <h3 class="section-title">गृह चौकशी</h3>
        <div class="row">
        ...
        <div class="col-md-4 col-sm-6">
            <div class="counter green">
                <div class="counter-content">
                    ...
                    <h3>गृह चौकशी साठी वाटप झालेले अर्ज</h3>
                </div>
                <span class="counter-value">845</span>
            </div>
        </div>
        <div class="col-md-4 col-sm-6">
            <div class="counter blue">
                <div class="counter-content">
                    ...
                    <h3>गृह चौकशी साठी वाटप न झालेले अर्ज</h3>
                </div>
                <span class="counter-value">179</span>
            </div>
        </div>
        ...
        <div class="chart-container">
            <div class="row">
                <div class="col-md-6 mb-5 vertical-divider">
                    <div class="chart-title">स्कूटिनी १ अर्ज - वार्षिक प्रगती (2024-2025)</div>
                    <canvas id="annualScrutinyChart"></canvas>
                    
                </div>
                <div class="col-md-6">
                    <div class="chart-title">गृह चोकशी अर्ज - वार्षिक प्रगती (2024-2025)</div>
