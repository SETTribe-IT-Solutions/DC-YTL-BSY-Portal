...
<head>
    ...
    <title>बाल कल्याण समिती डॅशबोर्ड</title>
...
<body>
    ...
    <div class="dashboard-container">
        <div class="dashboard-header text-center">
            <h1 class="dashboard-title">बाल कल्याण समिती डॅशबोर्ड</h1>
    ...
    <select class="form-select" id="yearSelect"></select>
        ...
        <!-- Summary Cards -->
        <h3 class="section-title">स्क्रूटीनी २</h3>
        <div class="row">
            ...
            <div class="counter">
                <div class="counter-content">
                    ...
                    <h3>स्क्रुटिनी २ साठी प्राप्त अर्ज</h3>
                </div>
        ...
        <div class="col-md-3 col-sm-6">
            <div class="counter green">
                <div class="counter-content">
                    ...
                    <h3> स्क्रूटीनी २ मध्ये रिजेक्टेड अर्ज </h3>
                </div>
                <span class="counter-value">845</span>
            </div>
        </div>
        <div class="col-md-3 col-sm-6">
            <div class="counter blue">
                <div class="counter-content">
                    ...
                    <h3> स्क्रुटिनी २ मध्ये मंजूर अर्ज </h3>
                </div>
                <span class="counter-value">179</span>
            </div>
        </div>
        <div class="col-md-3 col-sm-6">
            <div class="counter gray">
                <div class="counter-content">
                    ...
                    <h3>स्क्रूटीनी १ मध्ये मंजूर अर्ज</h3>
                </div>
                <span class="counter-value">179</span>
            </div>
        </div>
         ...
         <!-- गृह चौकशी -->
        <h3 class="section-title">बाल कल्याण समती हजेरी</h3>
        <div class="row">
            ...
            <div class="counter">
                <div class="counter-content">
                    ...
                    <h3>बा.क.स. समोर हजेरीसाठी पात्र अर्ज</h3>
                </div>
        ...
        <div class="col-md-4 col-sm-6">
            <div class="counter blue">
                <div class="counter-content">
                    ...
                    <h3>बा.क.स. हजर झालेले लाभार्थी</h3>
                </div>
                <span class="counter-value">179</span>
            </div>
        </div>
        ...
        <div class="row mt-4">
            ...
            <div class="counter gray">
                <div class="counter-content">
                    ...
                    <h3>बा.क.स. हजर न झालेले लाभार्थी</h3>
                </div>
                <span class="counter-value">250</span>
            </div>
        </div>
        <div class="col-md-4 col-sm-6">
            <div class="counter blue">
                <div class="counter-content">
                    ...
                    <h3>बा.क.स. शिफारस केलेले लाभार्थी</h3>
                </div>
                <span class="counter-value">845</span>
            </div>
        </div>
        <div class="col-md-4 col-sm-6">
            <div class="counter">
                <div class="counter-content">
                    ...
                    <h3>बा.क.स. द्वारे रिजेक्ट लाभार्थी</h3>
                </div>
                <span class="counter-value">179</span>
            </div>
        </div>
        ...
        <!-- मंजूर लाभार्थी -->
        <h3 class="section-title">मंजूर लाभार्थी</h3>
        <div class="row">
            <div class="col-md-4 col-sm-6">
            <div class="counter">
                <div class="counter-content">
        ...
        <div class="col-md-4 col-sm-6">
            <div class="counter green">
                <div class="counter-content">
                    ...
                    <h3>अंतिम रिजेक्टेड लाभार्थी</h3>
                </div>
                <span class="counter-value">845</span>
            </div>
        </div>
        <div class="col-md-4 col-sm-6">
            <div class="counter blue">
                <div class="counter-content">
                    ...
                    <h3>बाल संगोपन कार्ड डाउनलोड केलेले लाभार्थी</h3>
                </div>
                <span class="counter-value">179</span>
            </div>
        </div>
        ...
        <div class="chart-container">
            <div class="row">
                <div class="col-md-6 mb-5 vertical-divider">
                    <div class="chart-title">स्क्रुटिनी २ साठी प्राप्त अर्ज</div>
                    <canvas id="annualScrutinyChart"></canvas>
                    
                </div>
                <div class="col-md-6">
                    <div class="chart-title">बा.क.स. समोर हजेरीसाठी पात्र अर्ज</div>
