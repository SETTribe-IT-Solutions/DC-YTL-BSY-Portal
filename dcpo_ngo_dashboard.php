...
<head>
    ...
    <title>DCPO कर्मचारी किंवा NGO कर्मचारी डॅशबोर्ड</title>
...
<body>
    ...
    <div class="dashboard-container">
        <div class="dashboard-header text-center">
            <h1 class="dashboard-title">DCPO कर्मचारी किंवा NGO कर्मचारी डॅशबोर्ड</h1>
        ...
        <div class="chart-container">
            <div class="row">
                <div class="col-md-6 mb-5 vertical-divider">
                    <div class="chart-title">गृह चौकशी साठी वाटप झालेले अर्ज</div>
                    <canvas id="annualScrutinyChart"></canvas>
                </div>
                <div class="col-md-6">
                    <div class="chart-title">गृह चौकशी साठी वाटप न झालेले अर्ज</div>
